...
def format_evaluation_prompt(part_info: Dict[str, str], project_name: str, project_notes: str, bom_list: List[Dict[str, str]], mouser_results: List[Dict[str, Any]]) -> str:
    """
